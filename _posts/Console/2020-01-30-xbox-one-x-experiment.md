...
classes: wide
thumbnail: /images/Console/004/00.jpg
categories:
  - interests
tags:
  - console
...
![](/images/Console/004/00.jpg){: .align-center}
...
![](/images/Console/004/07.png){: .align-center}

디스크를 넣고 30초간 기다려봤지만, 인식조차 되지 않습니다. HD-DVD 포멧이 사실상 망했기 때문인지 XBOX ONE X에서는 인식하는 설정을 넣지 않은 것 같습니다.

## Bluray

![](/images/Console/004/08.png){: .align-center}

네 번째로 블루레이 디스크입니다. 준비한 타이틀은 BBC 셜록 시즌 4입니다.

![](/images/Console/004/09.png){: .align-center}

정상적으로 구동이 가능합니다.

## 4k Bluray

![](/images/Console/004/10.png){: .align-center}

다음으로는 4K 블루레이 디스크입니다. 준비한 타이틀은 알리시아 비칸데르의 툼 레이더 영화입니다.

![](/images/Console/004/11.png){: .align-center}

역시 블루레이 때와 마찬가지로 정상적으로 재생됩니다.

## PC-DVD

![](/images/Console/004/12.png){: .align-center}

이번에는 PC DVD 디스크입니다. 준비한 타이틀은 엘더 스크롤 5 : 스카이림 레전더리 에디션입니다.

![](/images/Console/004/13.png){: .align-center}

디스크를 넣으니 잠시 후 "디스크를 꺼내고 다시 시도하세요" 라는 경고창이 나오면서 실행이 되지 않습니다.

## SEGA Saturn

![](/images/Console/004/14.png){: .align-center}

다음으론 세가 새턴 디스크입니다. 준비한 타이틀은 버추얼 캅입니다.

![](/images/Console/004/15.png){: .align-center}

디스크가 인식이 되고 실행까지 되지만 엉뚱하게도 음악 CD로 인식이 됩니다. 트랙으로는 게임 내의 OST 목록이 나옵니다.

![](/images/Console/004/16.png){: .align-center}

재생해보면 정상적으로 실행이 됨을 확인했습니다. 세가 새턴 디스크는 게임을 실행할 수는 없지만, 대신 디스크에 들어있는 OST는 들을 수 있습니다.

## SEGA Dreamcast

![](/images/Console/004/17.png){: .align-center}

이어서 세가 드림캐스트 디스크입니다. 준비한 타이틀은 크레이지 택시입니다.

![](/images/Console/004/18.png){: .align-center}

세가 새턴 때와 마찬가지로 음악 CD로 인식이 됩니다. 다만 그 때와 달리 트랙이 2개만 나옵니다.

![](/images/Console/004/19.png){: .align-center}
...
![](/images/Console/004/20.png){: .align-center}
...
![](/images/Console/004/34.png){: .align-center}
...
![](/images/Console/004/37.png){: .align-center}

다음으로 XBOX 360 게임입니다. 마이크로소프트에서는 일부분의 XBOX 360 게임에 대한 하위호환을 지원하고 있습니다. 그래서 역시 두 개의 타이틀을 준비했는데, Skate 2 게임은 하위호환 지원 목록에 없는 게임이고, 닌자 가이덴 2는 하위호환 지원 목록에 있는 게임입니다.

![](/images/Console/004/38.png){: .align-center}

먼저 하위호환 지원 목록에 없는 Skate 2를 넣으니 레드 데드 리볼버와 마찬가지로 이 게임은 여기서 플레이할 수 없습니다 라는 경고창이 나오며 실행이 되지 않습니다.

![](/images/Console/004/39.png){: .align-center}
